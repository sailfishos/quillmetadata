...
void Dimensions::setDimensions(int widthValue, int heightValue)
{
    width = widthValue;
    height = heightValue;
}
...
void RegionInfo::setArea(Area areaValue)
{
    area = areaValue;
}
Area RegionInfo::getArea()
{
    return area;
}
...
void RegionInfo::setDimensions(Dimensions dimensionValue)
{
    imageDimensions = dimensionValue;
}

Dimensions RegionInfo::getDimensions()
{
